...
- Dynamic Query ("Ask the Model") — relational intelligence queries backed by the live knowledge graph
- Export capabilities
...
- **Cited as source material in Dynamic Query answers** — when a user asks a relational question, relevant Assessment excerpts surface in the supporting data panel. This is the highest-leverage surface for the Assessment because it reaches users who didn't know to look for it.
...
6. **Dynamic Query ("Ask the Model")** — depends on network map being built and assessments being populated. This is the feature that makes the Pro tier feel complete. Build before comparison tool because it demonstrates the model's depth more immediately than side-by-side charts.
7. **Actor Comparison Tool** — Phase 2, once core experience is solid.
8. **Full Research/Explore layer** — Phase 2.
