...
function parsePage(page: any): Actor {
  ...
  return {
    ...
    authorityReasoning: getText(props, 'Authority Reasoning') || undefined,
    reachReasoning: getText(props, 'Reach Reasoning') || undefined,
    pfReasoning: getText(props, 'PF Reasoning') || undefined,
